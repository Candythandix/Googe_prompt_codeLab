...
**CuteSnake** is a lightweight, adorable multi-tier desktop game built using **TSX**, **CSS**, and **JSON**. It takes the classic arcade game and adds a real-time global leaderboard, customized cozy themes, and simple socket-based online high-score tracking!
